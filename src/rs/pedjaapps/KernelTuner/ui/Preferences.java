...
<<<<<<< HEAD
	...
	private void main() {
		...
		mainStylePref
				.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preferenxe,
							Object newValue) {
						if (newValue.toString().equals("true")) {
							mainCpuPref.setEnabled(false);
							mainTogglesPref.setEnabled(false);
		...
		unsupportedPrefList = (ListPreference) findPreference("unsupported_items_display");
		unsupportedPrefList.setDefaultValue(unsupportedPrefList
				.getEntryValues()[0]);
		String unsupported = unsupportedPrefList.getValue();
		if (unsupported == null) {
			unsupportedPrefList.setValue((String) unsupportedPrefList
					.getEntryValues()[0]);
			unsupported = unsupportedPrefList.getValue();
		}
		unsupportedPrefList
				.setSummary(unsupportedPrefList.getEntries()[unsupportedPrefList
						.findIndexOfValue(unsupported)]);
		...
		unsupportedPrefList
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						unsupportedPrefList.setSummary(unsupportedPrefList
								.getEntries()[unsupportedPrefList
	...
	private void widget() {
		...
		if (widgetBg == null) {
			widgetPrefList
					.setValue((String) widgetPrefList.getEntryValues()[0]);
			widgetBg = widgetPrefList.getValue();
		}
		widgetPrefList.setSummary(widgetPrefList.getEntries()[widgetPrefList
				.findIndexOfValue(widgetBg)]);
	...
	private void logcat() {
		...
		levelPrefList.setSummary(levelPrefList.getEntries()[levelPrefList
				.findIndexOfValue(level)]);
		...
		if (buffer == null) {
			bufferPrefList
					.setValue((String) bufferPrefList.getEntryValues()[0]);
			buffer = bufferPrefList.getValue();
		}
		bufferPrefList.setSummary(bufferPrefList.getEntries()[bufferPrefList
				.findIndexOfValue(buffer)]);
		...
		if (format == null) {
			formatPrefList
					.setValue((String) formatPrefList.getEntryValues()[0]);
			format = formatPrefList.getValue();
		}
		formatPrefList.setSummary(formatPrefList.getEntries()[formatPrefList
				.findIndexOfValue(format)]);
		...
		if (textsize == null) {
			textsizePrefList.setValue((String) textsizePrefList
					.getEntryValues()[0]);
			textsize = textsizePrefList.getValue();
		}
		textsizePrefList
				.setSummary(textsizePrefList.getEntries()[textsizePrefList
						.findIndexOfValue(textsize)]);
		...
		textsizePrefList
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						textsizePrefList.setSummary(textsizePrefList
								.getEntries()[textsizePrefList
								.findIndexOfValue(newValue.toString())]);
						return true;
					}
				});
	...
	private void notif() {
		...
		notifPrefList.setSummary(notifPrefList.getEntries()[notifPrefList
				.findIndexOfValue(notif)]);
				...
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						if (isNotificationServiceRunning()) {
							stopService(new Intent(Preferences.this,
									NotificationService.class));
							startService(new Intent(Preferences.this,
									NotificationService.class));
						}
						return true;
					}
				...
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(Preference arg0) {
						...
						builder.setMessage(getResources().getString(
								R.string.notificatio_preferences_warning));
	...
	private void ui() {
		...
		tisList.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference preference,
					Object newValue) {
				tisList.setSummary(tisList.getEntries()[tisList
						.findIndexOfValue(newValue.toString())]);
		...
		cpuList.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference preference,
					Object newValue) {
				cpuList.setSummary(cpuList.getEntries()[cpuList
						.findIndexOfValue(newValue.toString())]);
	...
	private void app() {
		...
		tempPrefList.setSummary(tempPrefList.getEntries()[tempPrefList
				.findIndexOfValue(temp)]);
		...
		bootPrefList.setSummary(bootPrefList.getEntries()[bootPrefList
				.findIndexOfValue(boot)]);
				...
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(Preference arg0) {
						if (htcOneOverride.isChecked()) {
							...
							builder.setMessage(getResources().getString(
									R.string.htc_override_preferences_warning));
